...
[^research-4]: Creating better national cultural statistics with Eurobarometer datasets and ESSNet-Culture technical recommendations [@antal_creating_2015]
...
- Hungarian stakeholders interested in replication of the Slovak pilot versions in various meetings throughout 2024 and 2025[^research-7].

- The Fair MusE - Prelude to a fairermusic industry Fair MusE project[^research-8]

- IAMIC [^research-9]: The *International Association of Music Information Centres* and several key members of the organisation.

- IAML: The *International Association of Music Libraries, Archives and Documentation Centers* and several national chapters and key members [^research-10].

- Slovak national stakeholders interested in cultural data.[^research-11]

- Wikimedia community and developers.

- European music industry stakeholders on *LineCheck 2025* [^research-12]

[^research-7]: *Federation possibilities of the Slovak music data sharing space in Hungary* [@antal_2024_networkshop]

[^research-8]: We received useuful feedback for this Green Ppaer from the project and see further synergies in presenting our policy findings together. <https://fairmuse.eu/about/>

[^research-9]: We presented and discussed these ideas at the *International Association of Music Information Centres* on the General Assembly and Annual Conference 2024 on November 21, 2024, at Music Austria, Vienna. See the presentation and its poster format [@antal_iamic_presentation_2024; @skcmdb_iamic_poster_2024].

[^research-10]: We presented and discussed these ideas at the *International Association of Music Libraries, Archives and Documentation Centers* on the General Assembly and Annual Conference 7th and 9th of July 2025 in Salzburg, Austria. See the presentation and its poster format [@skcmdb_iaml_presentation_2025; @skcmdb_iaml_poster_2025].

[^research-11]: Based on a memorandum of understanding with a broad range of public and private stakeholders, [@open_music_europe_sk_mou_2023] we developed a model for renewing statistical production for better cultural and music statistics [@antal_slovak-cult-stat-pilot].

[^research-12]: *Open Access Music Dataspaces – Open Music Observatory* presented on LineCheck 2025 [@miks_antal_2025]
