...
In this programme, pragmatism does not mean abandoning semantic rigour. Rather, it means treating semantic objects as sufficiently stabilised when they support reproducible inference, communication, and reuse for a specified purpose while remaining open to revision in light of new observations, contextual evidence, or competing interpretations. Semantic stabilisation therefore seeks neither absolute certainty nor perfect representation, but progressively more robust and reusable semantic objects whose limitations remain explicit and reviewable.
...
Richard Rorty's interpretation of Davidson in *Contingency, Irony, and Solidarity* provides an equally important perspective. Rorty emphasises that successful communication does not require access to a final, universal vocabulary or a privileged semantic foundation. Rather, actors progressively develop shared interpretations that become sufficiently reliable for communication and action. Davidson's notion of "passing theories" captures this process well. Individuals do not begin with a perfectly shared language or ontology; they continually adjust their interpretations of one another until they reach a level of mutual understanding that is adequate for a given purpose.
...
This perspective is particularly relevant for semantic stabilisation. The objective is not to discover a final or universally correct representation of a concept, entity, or observation. Instead, the goal is to establish semantic correspondences that are sufficiently stable to support communication, inference, federation, and reuse while remaining open to revision. Semantic objects are therefore treated as contingent achievements rather than permanent truths.

Imre Lakatos's philosophy of science provides a complementary perspective on the progressive refinement of these semantic correspondences. Rather than treating semantic claims as simply true or false, semantic stabilisation treats them as working hypotheses that may become increasingly corroborated or increasingly challenged as new observations emerge. A counterexample does not necessarily invalidate an entire semantic framework; instead, it may motivate refinements, exceptions, or more precise formulations. In this sense, semantic stabilisation can be understood as a progressive and iterative process in which semantic objects become increasingly robust through repeated use, review, and corroboration.

> ... the typical descriptive unit of great scientific achievements is not an isolated hypothesis but rather a research programme. ... ‘All swans are white’ may be falsified by the discovery of one black swan. But such trivial trial and error does not rank as science. ... And, even more importantly, the research programme also has a ‘heuristic’, that is, a powerful problem-solving machinery, which, with the help of sophisticated mathematical techniques, digests anomalies and even turns them into positive evidence.
